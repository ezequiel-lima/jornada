...
namespace Jornada.Controllers
{
    ...
    public class DestinoController : ControllerBase
    {
        ...
        public DestinoController(IHandler<CreateDestinoCommand> createDestinoHandler, IDestinoRepository destinoRepository, IHandler<UpdateDestinoCommand> updateDestinoHandler, IHandler<DeleteDestinoCommand> deleteDestinoHandler)
        {
        ...
        public async Task<IActionResult> GetAllAsync()
        {
            try
            {
                var result = await _destinoRepository.GetAsync();
                var commandResult = new CommandResult(true, "Destinos recuperados com sucesso", result);
                return Ok(commandResult);
            }
            catch (Exception exception)
            {
                var commandResult = new CommandResult(false, "Erro 01xDT", exception.Message);
        ...
        public async Task<IActionResult> GetByIdAsync(Guid id)
        {
            try
            {
                var result = await _destinoRepository.GetByIDAsync(id);
                var commandResult = new CommandResult(true, "Destino recuperado com sucesso", result);
                return Ok(commandResult);
            }
            catch (Exception exception)
            {
                var commandResult = new CommandResult(false, "Erro 02xDT", exception.Message);
                return BadRequest(commandResult);
            }
        }
        ...
        public async Task<IActionResult> GetByNameAsync(string nome)
        {
            ...
            {
                var commandResult = new CommandResult(false, "Erro 03xDT", exception.Message);
                return BadRequest(commandResult);
            }
        }
        ...
        public async Task<IActionResult> PostAsync(CreateDestinoCommand command)
        {
            ...
            {
                var commandResult = new CommandResult(false, "Erro 04xDT", exception.Message);
                return BadRequest(commandResult);
            }
        }
        ...
        public async Task<IActionResult> PutAsync(Guid id, UpdateDestinoCommand command)
        {
            ...
            {
                var commandResult = new CommandResult(false, "Erro 05xDT", exception.Message);
                return BadRequest(commandResult);
            }
        }
        ...
        public async Task<IActionResult> DeleteAsync(Guid id, DeleteDestinoCommand command)
        {
            ...
            {
                var commandResult = new CommandResult(false, "Erro 06xDT", exception.Message);
                return BadRequest(commandResult);
            }
        }
    }
